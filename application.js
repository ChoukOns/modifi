...
const Application = () => {
  ...
  const categories = [
    ...
    { id: 5, name: t('Développement Personnel'), image: social },
  ...
  const Sidebar = () => {
    ...
    return (
      <div className="sidebar2">
        ...
        <div className={option1 === 'cours' ? 'active' : ''} onClick={() => setOption1('cours')}>
        <FontAwesomeIcon icon={faBook} /> {t('Gestion des cours')}
        </div><br />
